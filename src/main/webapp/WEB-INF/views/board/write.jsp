...
<body>
	...
	<main id="fullpage">
		...
		<form:form
				action='${root }board/write_pro?board_info_idx=${board_info_idx}'
				modelAttribute="writeContentBean" enctype="multipart/form-data" style="display:flex">
	<div class="slide"
					...
					<div class="card shadow">
						<div class="card-body">
							...
							<div class="form-group">
								...
								<form:select path="content_kategori" class='form-control'>
									<c:forEach var="kategori" items="${boardKategori}"
										varStatus="status">
										<option value="${kategori.kategoriNo}">${kategori.kategoriNm}</option>
									</c:forEach>
								</form:select>
							...
							<div class="form-group">
								...
								<form:textarea path="content_contest" class="form-control"
									rows="5" style="resize:none"/>
								<form:errors path='content_contest' style='color:red' />
							</div>
							<div class="form-group">
								<form:label path="user_age">생년월일</form:label><br>
								<input id="user_age" name="user_age" class='form-control-50' />								
							</div>
							<div class="form-group">
				...
				<div class="col-sm-6">
					<div class="card shadow">
						<div class="card-body">
							...
							취득일자
							<br>
							<input id="licenseDatepicker" name="license_date" class='form-control-50' />
							</div>
							...
							취득일자
							<br>
							<input id="licenseDatepicker2" name="license_date2" class='form-control-50' />
							</div>
				...
				<div class="col-sm-6">
					<div class="card shadow">
						<div class="card-body">
							...
							취득일자
							<br>
							<input id="licenseDatepicker3" name="license_date3" class='form-control-50' />
							</div>
							...
							취득일자
							<br>
							<input id="licenseDatepicker4" name="license_date4" class='form-control-50' />
							</div>
		...
		<div style="display:flex">
				...
				<div class="card shadow">
						<div class="card-body">
							...
							재학 기간
							<br>
							<input id="eduStDatepicker" name="eduSt_date" class='form-control-50' /> ~ <input id="eduEndDatepicker" name="eduEnd_date" class='form-control-50' />
							</div>
							<div class="form-group">
							...
							재학 기간
							<br>
							<input id="eduStDatepicker2" name="eduSt_date2" class='form-control-50' /> ~ <input id="eduEndDatepicker2" name="eduEnd_date2" class='form-control-50' />
							</div>
							<div class="form-group">
				...
				<div class="card shadow">
						<div class="card-body">
							...
							재학 기간
							<br>
							<input id="eduStDatepicker3" name="eduSt_date3" class='form-control-50' /> ~ <input id="eduEndDatepicker3" name="eduEnd_date3" class='form-control-50' />
							</div>
							<div class="form-group">
							...
							재학 기간
							<br>
							<input id="eduStDatepicker4" name="eduSt_date4" class='form-control-50' /> ~ <input id="eduEndDatepicker4" name="eduEnd_date4" class='form-control-50' />
							</div>
							<div class="form-group">
		...
		<div style="display:flex">
				...
				<div class="card shadow">
						<div class="card-body">
							...
							재직 기간
							<br>
							<input id="careerStDatepicker" name="careerSt_date" class='form-control-50' /> ~ <input id="careerEndDatepicker" name="careerEnd_date" class='form-control-50' />
							</div>
							<div class="form-group">
							...
							재직 기간
							<br>
							<input id="careerStDatepicker2" name="careerSt_date2" class='form-control-50' /> ~ <input id="careerEndDatepicker2" name="careerEnd_date2" class='form-control-50' />
							</div>
							<div class="form-group">
				...
				<div class="card shadow">
						<div class="card-body">
							...
							재직 기간
							<br>
							<input id="careerStDatepicker3" name="careerSt_date3" class='form-control-50' /> ~ <input id="careerEndDatepicker3" name="careerEnd_date3" class='form-control-50' />
							</div>
							<div class="form-group">
							...
							재직 기간
							<br>
							<input id="careerStDatepicker4" name="careerSt_date4" class='form-control-50' /> ~ <input id="careerEndDatepicker4" name="careerEnd_date4" class='form-control-50' />
							</div>
							<div class="form-group">
		...
		<div style="display:flex">
				...
				<div class="card shadow">
						<div class="card-body">
							...
							<div class="form-group">
								<form:label path="upload_file">WORK PIC.</form:label>
							...
							<div class="form-group">
								<form:label path="upload_file2">WORK PIC.</form:label>
				...
				<div class="card shadow">
						<div class="card-body">
							...
							<div class="form-group">
								<form:label path="upload_file3">WORK PIC.</form:label>
							...
							<div class="form-group">
								<form:label path="upload_file4">WORK PIC.</form:label>
