	...
	<header>
		<nav>
			...
			<ul>
				...
				<li data-menuanchor="section2"><a href="#section2" class="btn6">Career</a></li>
				<li data-menuanchor="section3"><a href="#section3" class="btn6">Awards</a></li>
				<li data-menuanchor="section4"><a href="#section4" class="btn6">Work</a></li>
				<li class="space"></li>
			...
			<div class="slide">
				<div class="outer-div"
					...
					<div class="inner-div">
						<div class="inner-hover">
							<div class="font-div">
								<span class="name-span">Profile1</span><br>
							</div>
							<div class="info-div">
								<span class="inner-span">
									<ul>
			...
			<div class="slide">
				<div class="outer-div"
					...
					<div class="inner-div">
						<div class="inner-hover">
							<div class="font-div">
								<span class="name-span">Profile2</span><br>
							</div>
							<div class="info-div">
								<span class="inner-span">
									<ul>
			...
			<div class="slide">
				<div class="outer-div"
					...
					<div class="inner-div">
						<div class="inner-hover">
							<div class="font-div">
								<span class="name-span">Profile3</span><br>
							</div>
							<div class="info-div">
								<span class="inner-span">
									<ul>
			...
			<div class="slide">
				<div class="outer-div"
					...
					<div class="inner-div">
						<div class="inner-hover">
							<div class="font-div">
								<span class="name-span">Career1</span><br>
							</div>
							<div class="info-div">
								<span class="inner-span">
									<ul>
				...
				<div class="slide">
					<div class="outer-div"
						...
						<div class="inner-div">
							<div class="inner-hover">
								<div class="font-div">
									<span class="name-span">Career2</span><br>
								</div>
								<div class="info-div">
									<span class="inner-span">
										<ul>
				...
				<div class="slide">
					<div class="outer-div"
						...
						<div class="inner-div">
							<div class="inner-hover">
								<div class="font-div">
									<span class="name-span">Career3</span><br>
								</div>
								<div class="info-div">
			...
			<div class="slide">
				<div class="outer-div"
					...
					<div class="inner-div">
						<div class="inner-hover">
							<div class="font-div">
								<span class="name-span">Awards1</span><br>
							</div>
							<div class="info-div">
								<span class="inner-span">요약 설명</span><br>
							</div>
			...
			<div class="slide">
				<div class="outer-div"
					...
					<div class="inner-div">
						<div class="inner-hover">
							<div class="font-div">
								<span class="name-span">Awards2</span><br>
							</div>
							<div class="info-div">
								<span class="inner-span">요약 설명</span><br>
							</div>
			...
			<div class="slide">
				<div class="outer-div"
					...
					<div class="inner-div">
						<div class="inner-hover">
							<div class="font-div">
								<span class="name-span">Awards3</span><br>
							</div>
							<div class="info-div">
								<span class="inner-span">요약 설명</span><br>
							</div>
			...
			<div class="slide">
				<div class="outer-div"
					...
					<div class="inner-div">
						<div class="inner-hover">
							<div class="font-div">
								<span class="name-span">Work1</span><br>
							</div>
							<div class="info-div">
								<span class="inner-span">요약 설명</span><br>
							</div>
			...
			<div class="slide">
				<div class="outer-div"
					...
					<div class="inner-div">
						<div class="inner-hover">
							<div class="font-div">
								<span class="name-span">Work2</span><br>
							</div>
							<div class="info-div">
								<span class="inner-span">요약 설명</span><br>
							</div>
			...
			<div class="slide">
				<div class="outer-div"
					...
					<div class="inner-div">
						<div class="inner-hover">
							<div class="font-div">
								<span class="name-span">Work3</span><br>
							</div>
							<div class="info-div">
								<span class="inner-span">요약 설명</span><br>
							</div>
